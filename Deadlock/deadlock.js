...
function addInitials() {
  ...
  if (isNaN(num) || num <= 0)
    ...
    if (isNaN(index)) {
      ...
      p.textContent = "Enter allocation matrix ";
      d1.appendChild(p);
      ...
      for (var i = 0; i < index; i++) {
        ...
        for (var j = 0; j < num; j++) {
          ...
          inp1.setAttribute("style", "color:black;background-color:white;width:50px;text-align:center;margin-right:50px;float:left;");
      ...
      p2.textContent = "Enter need matrix ";
      d2.appendChild(p2);
      var br = document.createElement("br");
      for (var i = 0; i < index; i++) {
